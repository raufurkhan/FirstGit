...
// POST REQUEST
function addTodo() {
    axios.post('https://jsonplaceholder.typicode.com/todos',{title:'post',completed:false}).then(res=>showOutput(res)).catch(err=>console.log(err))
}

// PUT/PATCH REQUEST
function updateTodo() {
    axios.patch('https://jsonplaceholder.typicode.com/todos/1',{title:'updatedTodo',completed:false}).then(res=>showOutput(res)).catch(err=>console.log(err))
}
...
function errorHandling() {
    ...
    .catch(err => {
      ...
      // axiosInstance.get('/comments').then(res => showOutput(res));z
}
